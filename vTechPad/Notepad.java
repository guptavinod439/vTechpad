...
boolean newFileFlag;
String fileName;
String applicationTitle="vTechPad";
...
/************************************/
public class Notepad  implements Printable,ActionListener, MenuConstants
{
...
String applicationName="vTechPad";
Paper paper ;
...
Notepad()
{
	...
	createMenuBar(f);
	   Image icon = Toolkit.getDefaultToolkit().getImage("pen.png");    
      f.setIconImage(icon); 
	f.pack();
...
pf = job.pageDialog(job.defaultPage());
    ...
    paper.setImageableArea(margin, margin, paper.getWidth() - margin * 2, paper.getHeight()
        - margin * 2);
    pf.setPaper(paper);
     f.setSize((int)(paper.getWidth() - margin * 2),(int)( paper.getHeight()- margin * 2));
...
findReplaceDialog.showDialog(f,true);//find
}
////////////////////////////////////
...
if(findReplaceDialog==null)
	findReplaceDialog=new FindDialog(ta);
findReplaceDialog.showDialog(f,false);//replace
}
////////////////////////////////////
...
ta.setWrapStyleWord(temp.isSelected());
...
{
JOptionPane.showMessageDialog(Notepad.this.f,aboutText,"vTechPad help line",JOptionPane.INFORMATION_MESSAGE);
}
...
final String helpAboutNotepad="About vTechPad";

final String aboutText=
	"<html><big>Your vTechPad</big><hr><hr>"
	+"<p align=right>Prepared by a vTech production!"
	+"<hr><p align=left>I Used jdk 8.0 to compile the source code.<br><br>"
	+"<strong>Thanx 4 using vTechPad</strong><br>"
	+"Ur Comments as well as bug reports are very welcome at<p align=center>"
	+"<hr><em><big>vTech123@gmail.com</big></em><hr><html>";
}
